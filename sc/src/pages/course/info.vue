...
<script>
	...
	export default{
		...
		created(){
			this.findAllCourse(this.currentPage);
		},
		methods: {
      ...
      handleDelete(index,row) {
        this.$confirm('此操作将永久删除该条记录, 是否继续?', '提示', {
          ...
          type: 'warning'
        	...
        	let ids = [row.id];
	      	this.batchDeleteCourse(ids).then((data)=>{
	      		this.findAllCourse(this.currentPage);
	      		this.$message({
	            type: 'success',
	            message: '操作成功!'
      ...
      handleSubmit(){
      	...
      	if(this.title == "新增课程信息"){
      		this.saveCourse(this.form).then((data)=>{
	      		this.findAllCourse(this.currentPage);
	      		this.$message({
	            type: 'success',
	            message: '操作成功!'
      		...
      		this.updateCourse(this.form).then((data)=>{
	      		this.findAllCourse(this.currentPage);
	      		this.$message({
	            type: 'success',
	            message: '操作成功!'
